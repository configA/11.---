...
int pos0=90,pos1=90,pos2=90,pos3=90;//角度
int pos0_old=90,pos1_old=90,pos2_old=90,pos3_old=90;//上一次的角度
/*************主函数*************/
void main()
{		
	Cls_init();
	pos0 = 10; pos1 = 180-130; pos2 = 180-148; pos3=0;
	_pt0on=1;
	PWM_Change_0(pos0);
	delay_ms(1000);
	_pt0on=0;//关闭基座
...
void Control_Angle()
{
	...
	if((pos0_old != pos0) || (pos1_old != pos1) || (pos2_old != pos2) ||(pos3_old != pos3))
	{
		...
		send_buff("   ");
		send_buff(Int2String(pos3,linshi));
		send_buff("\r\n");	
	}
	pos0_old = pos0; pos1_old = pos1; pos2_old = pos2; pos3_old = pos3;
